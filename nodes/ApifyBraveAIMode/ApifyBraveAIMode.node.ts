...
import { properties } from './ApifyBraveAIMode.properties';
import { runActor } from './helpers/executeActor';

// SNIPPET 1: Make sure the constants are correct
export const ACTOR_ID = 'u2azjcqJVle8Jbjyy' as string;

export const PACKAGE_NAME = 'n8n-nodes-brave-ai-mode-api' as string;
export const CLASS_NAME = 'ApifyBraveAIMode' as string;
...
export const X_PLATFORM_APP_HEADER_ID = 'brave-ai-mode-app' as string;

export const DISPLAY_NAME = 'Brave AI Mode' as string;
export const DESCRIPTION =
	'Get the Brave Search AI answer for a query, including the summary, references, and web results' as string;

export class ApifyBraveAIMode implements INodeType {
